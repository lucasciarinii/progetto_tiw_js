...
@WebServlet("/api/cliente/configurazione/cancella")
public class CancellaConfigurazione extends BaseApiServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            dao.deleteConfigurazione(configId);
            sendJson(resp, Map.of("ok", true));
        } catch (SQLException e) {
            throw new ServletException("Errore DB in CancellaConfigurazione", e);
        }
    }
}
